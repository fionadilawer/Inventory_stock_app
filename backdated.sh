...
NEW_AUTHOR_NAME="fionadilawer"
NEW_AUTHOR_EMAIL="fionadilawer@gmail.com"
START_DATE="2018-11-02 12:00:00"
...
git filter-branch -f --env-filter '
    ...
    # Set the new date and author/committer information for the commit
